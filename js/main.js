...
window.addEventListener(
  ...
  function () {
    ...
    const font = new FontFace('MiSans', 'url(' + './font/MiSans-Regular.woff2' + ')')
...
// fetch('https://yiketianqi.com/api?version=v6&appid=43986679&appsecret=TksqGZT7')
...
Author: 安田俊樹
Version: 0.0.1
Last updated：2023-05-21T03:47:18+08:00
 
Github:  https://github.com/andatoshiki/俊樹のStart
`
console.log(
  `%c${title1} %c${title2}
%c${content}`,
